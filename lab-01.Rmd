...
visitors %>% 
    summarise(
    mean_2022 = mean(n_2021, na.rm = TRUE),
...
**NA means not available because of a logic error**
...
**na.rm removes na prior to computation**
...
**It's disturbution is positively skewed**
...
summarise(prop = mean(admission == 'Free'))
